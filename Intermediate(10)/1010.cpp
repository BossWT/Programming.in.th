...
bool e(string text,int r,int c)
{
        ...
        for(int i=0; i<text.length(); i++)
        {
                if(map[r][c+i] == text[i] && c+i < column)
                        count++;
                else break;
        }
        if(count == text.length()) return true;
...
bool nw(string text,int r,int c)
{
        ...
        for(int i=0; i<text.length(); i++)
        {
                if(map[r-i][c-i] == text[i] && r-i >= 0 && c-i >= 0)
                        count++;
                else break;
        }
        if(count == text.length()) return true;
...
bool ne(string text,int r,int c)
{
        ...
        for(int i=0; i<text.length(); i++)
        {
                if(map[r-i][c+i] == text[i] && r-i >= 0 && c+i < column)
                        count++;
                else break;
        }
        if(count == text.length()) return true;
...
bool se(string text,int r,int c)
{
        ...
        for(int i=0; i<text.length(); i++)
        {
                if(map[r+i][c+i] == text[i] && r+i < row && c+i < column)
                        count++;
                else break;
        }
        if(count == text.length()) return true;
...
bool sw(string text,int r,int c)
{
        ...
        for(int i=0; i<text.length(); i++)
        {
                if(map[r+i][c-i] == text[i] && r+i < row && c-i >= 0)
                        count++;
                else break;
        }
        if(count == text.length()) return true;
